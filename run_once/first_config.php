...
define ('FIRST_CONFIG_PROCESS_URL', 'first_config_process.php');
...
<form method='post' action=" . FIRST_CONFIG_PROCESS_URL . ">
    <input type='submit' name='act' value = 'create database'>
</form>
...
<form method='post' action=" . FIRST_CONFIG_PROCESS_URL . ">
    <input type='submit' name='act' value = 'delete database'>
</form>
